...
for j=9
    ...
    j
    [t,Z0]=ode23t(@(t,Z0) rGap_Multiple_Supports(t,Z0,DD,A0,A1,A2,vect_N(j),eD,mnew,eta_s,kappa_s,nn,D_s,e,gd,f_s,NumbOp,ii,System_name),T,x0,opt);
    tEta=t/TN;
...
%% Построение графиков реакций
    tNS = 4;
    %NumbOp = 60:120:300;
    IND = 12;
Reactions(time{IND},ZZ{IND},TN,tNS,NumbOp,mnew,ii,kappa_s,eta_s,D_s,f_s,N,eD)
