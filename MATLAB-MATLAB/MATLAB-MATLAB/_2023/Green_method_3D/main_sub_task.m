...
%% Получение матриц
[Const_F0,Const_F2,Const_Fg,Const_F0_ticks,Const_F2_ticks,Const_Fg_ticks,Const_T,...
...
Const_F0 = Const_F0(2:m+1);
Const_F2 = Const_F2(2:m+1);
Const_Fg = Const_Fg(2:m+1);
Const_T = Const_T(2:m+1);
G00Int = G00Int(2:m+1,2:m+1);
G02Int = G02Int(2:m+1,2:m+1);
G03Int = G03Int(2:m+1,2:m+1);
G30Int = G30Int(2:m+1,2:m+1);
I = I(2:m+1,2:m+1);
Z = Z(2:m+1);
