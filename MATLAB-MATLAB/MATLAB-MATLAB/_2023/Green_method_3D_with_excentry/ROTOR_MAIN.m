...
zDisk=0.5;                  %[-] - кооридната расположения диска (*в пределах (0;1)*)
...
zeta_V = linspace(0.02,0.2,50);
for i = 1:length(zeta_V)        
    Ncritical(i) = Argan_diagram (N_initial,step_N,zeta_V(i));
end
%%
figure;
grid on; hold on; box on;
plot(zeta_V,Ncritical,'.-r','MarkerSize',14)
ff = gca;
ff.FontSize = 18;
