...
[fx,Xspectr]=spectrum_Fig_Power(ttInt,ZZx,0,PowerSignal);
[fy,Yspectr]=spectrum_Fig_Power(ttInt,ZZy,0,PowerSignal);
%%
figure('WindowState','maximized');
     ...
     ylabel('Амплитуда')
     title(['Спектр \xi_{\it x}; мощность ',num2str(PowerSignal*100),'%'])
     grid on;
     ...
     xlabel('Безразмерная частота')
     ylabel('Амплитуда')
     title(['Спектр \xi_{\it y}; мощность ',num2str(PowerSignal*100),'%'])
