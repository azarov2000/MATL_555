...
zi=0.05;               %V Коэффициент внутреннего линейного демпфирования ротора
...
Nmax=30;  % Максимальная скорость
Nkol=300; % Количество узлов 

Nmass=linspace(Nmin,Nmax,Nmax+1); % Вектор скоростей
