...
%% Построение биффуркационной диаграммы
 ...
 xlabel('Eccentricity','FontName','Times New Roman','FontSize',20)
 ...
 title([num2str(nT-NUMREV),' < nT < ',num2str(nT),'; ','\eta_{i} = ',num2str(zi),'; ','\eta_{e} = ',num2str(ze),'; ','\eta_{D \xi} = ',num2str(Ze),'; ','\eta_{D\vartheta} = ',num2str(Zte),'; ','\beta = ',num2str(beta),'; ',...
    '\beta_{R} = ',num2str(betaR),'; ','\kappa = ',num2str(kappa_s),'; ','D_{s} = ',num2str(D_s),'; ','f = ',num2str(f_s),'; ',...
        '\chi = ',num2str(eta_s),'; ','\gamma = ',num2str(gd)])
...
axes2 = axes('Parent',figure2);
    ...
    title(['\eta_{i} = ',num2str(zi),'; ','\eta_{e} = ',num2str(ze),'; ','\eta_{D \xi} = ',num2str(Ze),'; ','\eta_{D\vartheta} = ',num2str(Zte),'; ','\beta = ',num2str(beta),'; ',...
     '\beta_{R} = ',num2str(betaR),'; ','\kappa = ',num2str(kappa_s),'; ','D_{s} = ',num2str(D_s),'; ','f = ',num2str(f_s),'; ',...
        '\chi = ',num2str(eta_s),'; ','\epsilon = ',num2str(vect_disbalance(IND)),'; ','\gamma = ',num2str(gd)])
